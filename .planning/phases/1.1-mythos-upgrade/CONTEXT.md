...
1. **Spectral Stability**: There is no hard constraint on the recurrent weights, making $n_loops &gt; 1$ risky.
...
- **JAX/Equinox Pattern**: We will use log-parameterization ($log_A$ and $log_dt$) to ensure $A = exp(-exp(...))$. This is the standard "LTI-stable" construction.
