...
Original file is located at
    https://colab.research.google.com/drive/1P39pbWHhABja9QKUKkE00ikp0a_CJdOL
...
# NOTE: drift is not available post-hoc (we only have final params).
# Backfill metrics for plateau/diversity analysis only.
for i, mf in enumerate(egg_history["mean_fitness"]):
    ...
    diag.log_step(
        ...
        trainable,
        {
            ...
            "fitness_std": egg_history["fitness_std"][i] if i < len(egg_history["fitness_std"]) else 0.0,
